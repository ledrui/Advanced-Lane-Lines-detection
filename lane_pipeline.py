...
class LanePipeline:
    ...
    def set_values(l, m, minv, cammat, distcoeff):
        LanePipeline.line = l
        LanePipeline.M = m
        LanePipeline.Minv = minv
        LanePipeline.cameraMat = cammat
        LanePipeline.distCoeffs = distcoeff

    @staticmethod
    def pipeline(img):
        line, M, Minv, cameraMat, distCoeffs = LanePipeline.line, LanePipeline.M, LanePipeline.Minv, LanePipeline.cameraMat, LanePipeline.distCoeffs
        ...
        cv2.putText(result, 'Radius of Curvature: %.2fm' % line.curvature, (20, 40), cv2.FONT_HERSHEY_SIMPLEX, 1,
                    (255, 255, 255), 2)
